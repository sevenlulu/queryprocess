...
singer_synonym_dict = {}
tup_in_dict = []
singer_synonym_file = open(os.path.abspath(os.path.curdir)+'/data/xiamifilters.prop')
...
singer_custom_dict = open(os.path.abspath(os.path.curdir)+'/data/singer_custom_dict.txt', 'w')
for word in singer_custom_list: 
